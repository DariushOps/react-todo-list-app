...
export default function NewProject({ onAdd, onCancel }) {
  ...
  return (
    <>
      <Modal ref={modal} captionButton="Close">
        <h2 className="text-xl font-bold my-4 text-stone-700">Invalid input</h2>
        <p className="text-stone-600 mb-4">
          Oops... locks like you forgot to enter a value
        </p>
        <p className="text-stone-600 mb-4">
      ...
      <div className="w-[35rem] mt-16">
        <menu className="flex gap-4 items-center justify-end my-4 ">
          ...
          <li>
            <button
              onClick={handleSave}
              className="font-bold px-6 py-2 bg-stone-800 text-stone-50 hover:bg-stone-950 rounded-[0.5rem]"
            >
              Save
            </button>
          </li>
